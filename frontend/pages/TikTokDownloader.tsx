...
const TikTokDownloader: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-pink-500 selection:text-white pb-20 overflow-x-hidden">
            ...
            <main className="container mx-auto relative z-10 pb-12">
                <InputArea
                    ...
                    Icon={TikTokIcon}
                    // TikTok colors: Black rgb(0,0,0) / Cyan rgb(37,244,238) / Pink rgb(254,44,85)
                    gradientText="bg-gradient-to-r from-black via-pink-500 to-cyan-400"
                    gradientButton="bg-gradient-to-r from-black via-pink-600 to-cyan-500"
                    bgDecorClass="bg-pink-500"
                />
